...
import { sendVerificationEmail as sendVerificationEmailUtil, sendPasswordResetEmail, sendOtpEmail } from '../utils/emailUtils.js';
...
export const verifyOtp = async (req, res) => {
  try {
    ...
    const user = await User.findOne({ 
      email,
      verificationOtp: otp,
      verificationOtpExpiry: { $gt: new Date() } // OTP not expired
    });
